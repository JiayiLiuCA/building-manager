...
export function CompanyChatPage() {
  ...
  return (
    <div className="space-y-3">
      <PageHeader title="AI 咨询" description={`AI 助手实时解答账单、报修、通知、发票等问题;人工服务请拨打 ${SERVICE_PHONE}`}>
        <AiBadge />
      </PageHeader>
      ...
      <Card className="py-0">
        <CardContent className="flex h-[480px] flex-col p-0">
          ...
          >
            <Input
              placeholder="输入您的问题,如:我们的账单和欠费情况?"
              value={input}
      ...
      <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
        ...
        电话咨询:{SERVICE_PHONE}(工作日 8:30-18:00),紧急报修 24 小时受理
      </p>
    </div>
  )
}
